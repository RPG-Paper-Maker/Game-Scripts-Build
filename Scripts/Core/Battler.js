...
import { ALIGN, ALIGN_VERTICAL, BATTLER_STEP, ELEMENT_MAP_KIND, Interpreter, PICTURE_KIND, } from '../Common/index.js';
...
export class Battler {
    ...
    constructor(player, isEnemy = false, position, vect, camera) {
        ...
        this.progressionRunX = null;
        this.progressionRunZ = null;
        this.timerRunMove = 0;
    ...
    updateStatusStep() {
        ...
        if (this.player.isDead()) {
            step = Data.Status.get(1).battlerPosition.getValue();
        }
        else {
