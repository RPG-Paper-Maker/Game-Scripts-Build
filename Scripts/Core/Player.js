...
class Player {
    constructor(kind, id, instanceID, skills, status, name, json) {
        ...
        this.temporaryBattlerID = null;
        this.temporaryFacesetID = null;
        this.temporaryFacesetIndexX = null;
        this.temporaryFacesetIndexY = null;
        if (kind !== undefined) {
            this.kind = kind;
            this.id = id;
     ...
     *  @returns {number}
     */
    getBattlerID(useTemporary = true) {
     ...
     *  @returns {number}
     */
    getFacesetID(useTemporary = true) {
     ...
     *  @returns {number}
     */
    getFacesetIndexX(useTemporary = true) {
     ...
     *  @returns {number}
     */
    getFacesetIndexY(useTemporary = true) {
