...
class GL {
     ...
     */
    static applyScreenTone(material) {
        ...
        material.onBeforeCompile = (shader, renderer) => {
            ...
            shader.fragmentShader = shader.fragmentShader.replace('#include <fog_fragment>', `vec3 rpmScreenToneRgb = gl_FragColor.rgb + rpmScreenTone.rgb;
...
#include <fog_fragment>`);
        ...
        material.customProgramCacheKey = () => `${customProgramCacheKey.call(material)}|rpm-screen-tone`;
