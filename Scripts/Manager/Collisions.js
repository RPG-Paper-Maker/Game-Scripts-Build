...
class Collisions {
    ...
    static resetBoxGeometry(box) {
        ...
        const normal = box.geometry.getAttribute('normal');
     ...
     */
    static sanitizeBoundingBox(boundingBox) {
    ...
    static checkRay(positionBefore, positionAfter, object, bbSettings, reverseTestObjects = false) {
        ...
        let yMountain = null;
        const mountainCollisionHeight = Data.Systems.mountainCollisionHeight.getValue() / Data.Systems.SQUARE_SIZE;
    ...
    static checkLandObjects(jpositionBefore, jpositionAfter, direction, object) {
        ...
        if (lands) {
            for (const { object: landObject, collision } of lands) {
                if (landObject === object || !collision.b)
                    continue;
                const b = collision.b;
                const boundingBox = [
                    ...
                    landObject.position.y +
                        b[1] +
                        (landObject.positionLayer + landObject.currentStateInstance.layer.getValue()) *
                ...
                if (this.checkIntersectionLand(collision.cs, boundingBox, object) ||
                    this.checkDirections(jpositionBefore, jpositionAfter, collision.cs, boundingBox, direction, object)) {
                    return true;
                }
            }
        }
    ...
    static checkIntersectionMountain(mapPortion, jpositionAfter, positionAfter, objCollision, object) {
        ...
        const mtnCollisionHeight = Data.Systems.mountainCollisionHeight.getValue() / Data.Systems.SQUARE_SIZE;
...
Collisions._unitBoxVertices = null;
Collisions._unitBoxNormals = null;
export { Collisions };
