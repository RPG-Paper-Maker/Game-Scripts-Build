...
class Player extends Base {
    constructor(player, { isMainMenu = false, reverse = false, useHeroesStatistics = false, useTemporaryGraphics = true, } = {}) {
        super();
     ...
     */
    drawCharacter(x, y, w, h, yOffset = ScreenResolution.getScreenY(150)) {
        // Battler
        const coef = Constants.BASIC_SQUARE_SIZE / Data.Systems.SQUARE_SIZE;
        ...
        this.battlerRect.setCoords(x, y + yOffset - hBattler * coef - ScreenResolution.getScreenY(23), wBattler * coef, hBattler * coef);
        this.battler.draw({
    ...
    drawChoice(x, y, w, h) {
        ...
        const xLevelName = xCharacter + this.graphicName.textWidth + ScreenResolution.getScreenX(Constants.MEDIUM_SPACE);
        ...
        if (this.player.levelingUp) {
            this.graphicLevelUp.draw(xLevel + this.graphicLevel.textWidth + ScreenResolution.getScreenX(Constants.MEDIUM_SPACE), yName, 0, 0);
        }
        ...
        if (this.graphicExpName !== null) {
            ...
            this.graphicExp.draw(xCharacter + this.graphicExpName.textWidth + ScreenResolution.getScreenX(Constants.MEDIUM_SPACE), yExp, 0, 0);
        }
    }
    /**
