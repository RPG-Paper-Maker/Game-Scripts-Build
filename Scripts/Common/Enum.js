...
export var DISPLAY_PICTURE_KIND;
(function (DISPLAY_PICTURE_KIND) {
    DISPLAY_PICTURE_KIND[DISPLAY_PICTURE_KIND["PICTURE"] = 0] = "PICTURE";
    DISPLAY_PICTURE_KIND[DISPLAY_PICTURE_KIND["TEXT"] = 1] = "TEXT";
})(DISPLAY_PICTURE_KIND || (DISPLAY_PICTURE_KIND = {}));
...
(function (EVENT_COMMAND_KIND) {
    ...
    EVENT_COMMAND_KIND[EVENT_COMMAND_KIND["CHANGE_FOG"] = 79] = "CHANGE_FOG";
    EVENT_COMMAND_KIND[EVENT_COMMAND_KIND["MODIFY_LIGHT"] = 80] = "MODIFY_LIGHT";
    EVENT_COMMAND_KIND[EVENT_COMMAND_KIND["CHANGE_LOCAL_VARIABLE"] = 81] = "CHANGE_LOCAL_VARIABLE";
...
(function (DYNAMIC_VALUE_KIND) {
    ...
    DYNAMIC_VALUE_KIND[DYNAMIC_VALUE_KIND["LOCAL_VARIABLE"] = 71] = "LOCAL_VARIABLE";
...
(function (TAG_KIND) {
    ...
    TAG_KIND[TAG_KIND["LOCAL_VARIABLE"] = 17] = "LOCAL_VARIABLE";
})(TAG_KIND || (TAG_KIND = {}));
...
(function (VARIABLE_MAP_OBJECT_CHARACTERISTIC_KIND) {
    ...
    VARIABLE_MAP_OBJECT_CHARACTERISTIC_KIND[VARIABLE_MAP_OBJECT_CHARACTERISTIC_KIND["PROPERTY"] = 8] = "PROPERTY";
