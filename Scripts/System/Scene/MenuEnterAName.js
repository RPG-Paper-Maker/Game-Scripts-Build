...
class MenuEnterAName extends MenuBase {
    ...
    drawHUD() {
        ...
        this.pictureFaceset.draw({ sx: this.selectedhero.system.indexXFaceset *
                ...
                * Datas.Systems.facesetsSize, sw: Datas.Systems.facesetsSize, sh: Datas.Systems.facesetsSize, w: Datas.Systems.facesetScalingWidth, h: Datas.Systems.facesetScalingHeight, x: this.windowChoicesTop.x - this
